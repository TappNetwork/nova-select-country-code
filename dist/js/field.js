...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-select-country-code', __webpack_require__(3));
  Vue.component('detail-select-country-code', __webpack_require__(6));
  Vue.component('form-select-country-code', __webpack_require__(9));
});
  ...
  computed: {
    selected: function selected() {
      ...
      return this.options.find(function (item) {
        return item['country_code'] == _this.field.value;
      });
    }
  }
});
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _vm.field.value
      ? _c("div", { attrs: { slot: "value" }, slot: "value" }, [
          _c("span", [
            _vm.selected.iso_code
              ? _c("span", [
                  _c("img", {
                    staticClass: "pr-2 h-4 w-8 align-middle",
                    attrs: {
                      src:
                        _vm.field.iconsDirectory +
                        "/" +
                        _vm.selected.iso_code.toLowerCase().trim() +
                        "." +
                        _vm.field.iconsFormat
                    }
                  })
                ])
              : _vm._e(),
            ...
            _vm._v(" "),
            _c("span", { staticClass: "text-xs align-middle" }, [
              _vm._v(
                "\n        (" + _vm._s(_vm.selected.country_code) + ")\n      "
              )
            ])
          ])
        ])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_select__ = __webpack_require__(12);
  ...
  methods: {
    ...
    setInitialValue: function setInitialValue() {
      ...
      if (this.field.value) {
        ...
        this.selected = this.options.find(function (item) {
          return item['country_code'] == _this.field.value;
        });
      }
    },
            ...
            scopedSlots: _vm._u([
              {
                key: "no-options",
                fn: function() {
                  return [_c("span", [_vm._v("Sorry, no options available!")])]
                },
                proxy: true
              },
              {
                          ...
                          _c("img", {
                            ...
                            attrs: {
                              src:
                                _vm.field.iconsDirectory +
                                "/" +
                                option.iso_code.toLowerCase().trim() +
                                "." +
                                _vm.field.iconsFormat
                            }
                          })
